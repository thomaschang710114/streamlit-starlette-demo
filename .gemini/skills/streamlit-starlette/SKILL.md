...
**Reference**: [references/mount_fastapi.py](references/mount_fastapi.py)
...
**Reference**: [references/middleware_security_headers.py](references/middleware_security_headers.py)

### Pattern: Auth Cookie Middleware

Block access if user is not authenticated (cookie check).

**Reference**: [references/middleware_auth.py](references/middleware_auth.py)

### Pattern: Cookie Management

Set and read cookies via middleware.

**Reference**: [references/middleware_cookies.py](references/middleware_cookies.py)

### Pattern: IP Whitelist

Restrict access to specific IP addresses.

**Reference**: [references/middleware_ip_whitelist.py](references/middleware_ip_whitelist.py)
...
**Reference**: [references/core_lifespan_lifecycle.py](references/core_lifespan_lifecycle.py)

### Pattern: MCP Server Integration

Expose endpoints as MCP tools for AI agents (requires `fastmcp`).

**Reference**: [references/route_mcp_server.py](references/route_mcp_server.py)

### Pattern: SEO Endpoints

Serve `robots.txt`, `sitemap.xml`, and `manifest.json` for SEO and PWA support.

**Reference**: [references/route_seo_metadata.py](references/route_seo_metadata.py)
